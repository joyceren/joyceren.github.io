    ...
    return (
      <div className="main">
        ...
        <div className= "article-list">
          {this.state && this.state.articles.map((a, i) => <ArticleCard article={a} id={i} key={i}/>)}
        </div>
      </div>
    )
  }
...
//   return (
//     <div className="main">
//       <div className="intro" onClick={props.fetchArticles}>
//           Take control of your news.
//       </div>
//       <div className="nav-btn-container">
//         <div className='nav-btn'>Top Headlines</div>
...
//       </div>
//       <div className= "article-list">
//         {props.articles.map((a, i) => <ArticleCard article={a} id={i} key={i}/>)}
//       </div>
//     </div>
//   )
// }
